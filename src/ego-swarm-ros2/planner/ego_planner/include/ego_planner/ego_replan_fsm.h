...
namespace ego_planner
{
    class EGOReplanFSM
    {
        ...
        void waypointCallback(geometry_msgs::msg::PoseStamped::ConstSharedPtr msg);
        void triggerCallback(geometry_msgs::msg::PoseStamped::ConstSharedPtr msg);
        void odometryCallback(nav_msgs::msg::Odometry::ConstSharedPtr msg);
        void swarmTrajsCallback(traj_utils::msg::MultiBsplines::ConstSharedPtr msg);
        void BroadcastBsplineCallback(traj_utils::msg::Bspline::ConstSharedPtr msg);

        bool checkCollision();
        void publishSwarmTrajs(bool startup_pub);

    public:
        EGOReplanFSM() = default;
