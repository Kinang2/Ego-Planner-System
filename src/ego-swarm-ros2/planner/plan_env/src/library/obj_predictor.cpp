...
namespace fast_planner
{
    ...
    void ObjHistory::poseCallback(geometry_msgs::msg::PoseStamped::ConstSharedPtr msg)
    {
        ++skip_;
        if (skip_ < skip_num_)
            return;
    ...
    void ObjPredictor::markerCallback(visualization_msgs::msg::Marker::ConstSharedPtr msg)
    {
        int idx = msg->id;
