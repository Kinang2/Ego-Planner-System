...
private:
    ...
    void extrinsicCallback(nav_msgs::msg::Odometry::ConstSharedPtr odom);
    void depthOdomCallback(sensor_msgs::msg::Image::ConstSharedPtr img, nav_msgs::msg::Odometry::ConstSharedPtr odom);
